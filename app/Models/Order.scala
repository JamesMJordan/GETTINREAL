...
object Order {
  ...
  def create(name: String, address1: String, address2: String, city: String, state: String, zipcode: String): Long = {
    DB.withConnection { implicit c =>
      SQL("INSERT INTO Order(name, address1, address2, city, state, zipcode) VALUES({name}, {address1}," +
